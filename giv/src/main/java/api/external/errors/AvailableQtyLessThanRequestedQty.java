...
@Data
@NoArgsConstructor
public class AvailableQtyLessThanRequestedQty extends Exception {
	...
	public AvailableQtyLessThanRequestedQty(String exception, String responseQty, String onHandQty, String allocatedQty, String protectedQty, String lockedQty, String availableQty) {
    super(exception);
