...
@Data
@NoArgsConstructor
public class AvailableQtyZero extends Exception {
	/**
	 * 
	 */
	...
	public AvailableQtyZero(String exception, String responseQty, String onHandQty, String allocatedQty, String protectedQty, String lockedQty, String availableQty) {
    super(exception);
