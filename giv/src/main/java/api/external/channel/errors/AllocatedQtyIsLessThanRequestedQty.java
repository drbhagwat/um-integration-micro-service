...
@Data
@NoArgsConstructor
public class AllocatedQtyIsLessThanRequestedQty extends Exception {
	/**
	 * 
	 */
	...
	public AllocatedQtyIsLessThanRequestedQty(String exception, String responseQty, String onHandQty, String allocatedQty, String protectedQty, String lockedQty, String availableQty) {
    super(exception);
