...
@Data
@NoArgsConstructor
public class AvailableQtyAndProtectQtyZero extends Exception {
	/**
	 * 
	 */
	...
	public AvailableQtyAndProtectQtyZero(String exception, String responseQty, String onHandQty, String allocatedQty, String protectedQty, String lockedQty, String availableQty) {
    super(exception);
